...
const EVENT_CATALOG: Record<string, EventCatalogEntry> = {
  ...
  "Microsoft-Windows-RemoteDesktopServices-RdpCoreTS|131": { category: "RDP", label: "RDP 전송 계층 연결 수립" },
  "Microsoft-Windows-WMI-Activity|5857": { category: "WMI", label: "WMI 프로바이더 로드" },
  "Microsoft-Windows-WMI-Activity|5858": { category: "WMI", label: "WMI 쿼리 오류 기록" },
  "Microsoft-Windows-WMI-Activity|5859": { category: "WMI", label: "WMI 필수 이벤트 필터 활성" },
  "Microsoft-Windows-WMI-Activity|5860": { category: "WMI", label: "WMI 임시 이벤트 구독" },
  "Microsoft-Windows-WinRM|6": { category: "원격 관리", label: "WinRM 클라이언트 연결 시작" },
  "Microsoft-Windows-Shell-Core|9707": { category: "영속성", label: "Run 키 명령 실행 시작" },
  "Microsoft-Windows-Shell-Core|9708": { category: "영속성", label: "Run 키 명령 프로세스 생성" },
...
"Microsoft-Windows-Bits-Client|4": { category: "네트워크", label: "BITS 전송 작업 완료" },
  "Microsoft-Windows-Bits-Client|5": { category: "네트워크", label: "BITS 작업 취소" },
  "Microsoft-Windows-Bits-Client|61": { category: "네트워크", label: "BITS 전송 오류" },
  "Microsoft-Windows-Security-Auditing|4616": { category: "시스템", label: "시스템 시간 변경" },
  "Microsoft-Windows-Security-Auditing|4699": { category: "지속성", label: "예약 작업 삭제" },
  "Microsoft-Windows-Security-Auditing|4703": { category: "권한", label: "토큰 권한 조정" },
  "Microsoft-Windows-Security-Auditing|4725": { category: "계정", label: "계정 비활성화" },
  "Microsoft-Windows-Security-Auditing|4733": { category: "계정", label: "로컬 그룹 구성원 제거" },
  "Microsoft-Windows-Security-Auditing|4735": { category: "계정", label: "로컬 그룹 변경" },
  "Microsoft-Windows-Security-Auditing|5142": { category: "공유", label: "네트워크 공유 추가" },
  "Microsoft-Windows-Security-Auditing|5144": { category: "공유", label: "네트워크 공유 삭제" },
  "Microsoft-Windows-TaskScheduler|100": { category: "지속성", label: "예약 작업 시작" },
  "Microsoft-Windows-TaskScheduler|102": { category: "지속성", label: "예약 작업 완료" },
  "Microsoft-Windows-TaskScheduler|107": { category: "지속성", label: "트리거로 작업 실행" },
  "Microsoft-Windows-TaskScheduler|110": { category: "지속성", label: "사용자가 작업 실행" },
  "Microsoft-Windows-Windows Firewall With Advanced Security|2004": { category: "방화벽", label: "방화벽 규칙 추가" },
  "Microsoft-Windows-Windows Firewall With Advanced Security|2005": { category: "방화벽", label: "방화벽 규칙 변경" },
  "Microsoft-Windows-Windows Firewall With Advanced Security|2006": { category: "방화벽", label: "방화벽 규칙 삭제" },
  "Microsoft-Windows-Windows Firewall With Advanced Security|2033": { category: "방화벽", label: "방화벽 규칙 일괄 삭제" },
  "Microsoft-Windows-Windows Firewall With Advanced Security|2010": { category: "방화벽", label: "방화벽 프로필 전환" },
  "Microsoft-Windows-Windows Firewall With Advanced Security|2002": { category: "방화벽", label: "방화벽 설정 변경" },
  "Microsoft-Windows-Windows Firewall With Advanced Security|2003": { category: "방화벽", label: "방화벽 설정 변경" },
  "Microsoft-Windows-Windows Firewall With Advanced Security|2011": { category: "방화벽", label: "방화벽 수신 차단 알림" },
  "Microsoft-Windows-Security-Auditing|4946": { category: "방화벽", label: "방화벽 규칙 추가 (감사)" },
  "Microsoft-Windows-Security-Auditing|4947": { category: "방화벽", label: "방화벽 규칙 변경 (감사)" },
  "Microsoft-Windows-Security-Auditing|4948": { category: "방화벽", label: "방화벽 규칙 삭제 (감사)" },
  "Microsoft-Windows-Security-Auditing|4950": { category: "방화벽", label: "방화벽 설정 변경 (감사)" },
  "Microsoft-Windows-Security-Auditing|5025": { category: "방화벽", label: "방화벽 서비스 중지" },
  "Microsoft-Windows-Security-Auditing|5031": { category: "방화벽", label: "방화벽 인바운드 수신 차단" },
  "Microsoft-Windows-Sysmon|1": { category: "프로세스", label: "프로세스 생성 (Sysmon)" },
  "Microsoft-Windows-Sysmon|3": { category: "네트워크", label: "네트워크 연결 (Sysmon)" },
  "Microsoft-Windows-Sysmon|8": { category: "프로세스", label: "원격 스레드 생성 (Sysmon)" },
  "Microsoft-Windows-Sysmon|11": { category: "파일", label: "파일 생성 (Sysmon)" },
  "Microsoft-Windows-Sysmon|13": { category: "레지스트리", label: "레지스트리 값 변경 (Sysmon)" },
  "Microsoft-Windows-Sysmon|22": { category: "네트워크", label: "DNS 질의 (Sysmon)" },
  ...
  "PowerShell|403": { category: "PowerShell", label: "엔진 종료" },
  "PowerShell|600": { category: "PowerShell", label: "공급자 시작" },
  "Microsoft-Windows-PowerShell|40961": { category: "PowerShell", label: "콘솔 시작" },
